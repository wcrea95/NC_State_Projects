...
set_module_property NAME sha256_system
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME sha256_system
set_module_property TOP_LEVEL_HDL_FILE sha256_system.v
set_module_property TOP_LEVEL_HDL_MODULE sha256_system
...
### SLAVE interface avs_sha256_cra
add_interface avs_sha256_cra avalon end
set_interface_property avs_sha256_cra addressAlignment DYNAMIC
set_interface_property avs_sha256_cra burstOnBurstBoundariesOnly false
set_interface_property avs_sha256_cra explicitAddressSpan 0
set_interface_property avs_sha256_cra holdTime 0
set_interface_property avs_sha256_cra isMemoryDevice false
set_interface_property avs_sha256_cra isNonVolatileStorage false
set_interface_property avs_sha256_cra linewrapBursts false
set_interface_property avs_sha256_cra maximumPendingReadTransactions 1
set_interface_property avs_sha256_cra printableDevice false
set_interface_property avs_sha256_cra readLatency 0
set_interface_property avs_sha256_cra readWaitTime 1
set_interface_property avs_sha256_cra setupTime 0
set_interface_property avs_sha256_cra timingUnits Cycles
set_interface_property avs_sha256_cra writeWaitTime 0
set_interface_property avs_sha256_cra ASSOCIATED_CLOCK clock_reset
set_interface_property avs_sha256_cra ENABLED true
add_interface_port avs_sha256_cra avs_sha256_cra_read read Input 1
add_interface_port avs_sha256_cra avs_sha256_cra_write write Input 1
add_interface_port avs_sha256_cra avs_sha256_cra_address address Input 4
add_interface_port avs_sha256_cra avs_sha256_cra_writedata writedata Input 64
add_interface_port avs_sha256_cra avs_sha256_cra_byteenable byteenable Input 8
add_interface_port avs_sha256_cra avs_sha256_cra_waitrequest waitrequest Output 1
add_interface_port avs_sha256_cra avs_sha256_cra_readdata readdata Output 64
add_interface_port avs_sha256_cra avs_sha256_cra_readdatavalid readdatavalid Output 1
...
add_file acl_ic_local_mem_router.v {SYNTHESIS SIMULATION}
add_file acl_ic_local_mem_router_terminator.v {SYNTHESIS SIMULATION}
...
add_file sha256.v {SYNTHESIS SIMULATION}
